...
Таблица с итоговым счетом [в формате TSV](rank.tsv).

Для дальнейшей работы над корпусом к результатам прилагается `таблица сложности` [в формате TSV](hardness.tsv) 
...
Образцом считается [ре-верефицированной версией третьей ревизии корпуса](data/temporal-corpora-ru-rev3-resolved.csv)
